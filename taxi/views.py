...
from .forms import DriverCreatingForm, DriverLicenseUpdateForm, CarCreatingForm
...
class AssignToCar(LoginRequiredMixin, generic.UpdateView):
    model = Car
    fields = "__all__"
